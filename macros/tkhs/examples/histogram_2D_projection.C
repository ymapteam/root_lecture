// histogram_2D_projection.C

void histogram_2D_projection(){
    ...
    hist->Draw("COLZ");
    can->cd(2);
    TH1D* hist_projY = (TH1D*)hist->/*ここを変えて*/("hist_projY");
    hist_projY->Draw("E");
    can->cd(3);
    TH1D* hist_projX = (/*ここを変えて*/*)hist->ProjectionX("hist_projX", /*ここを変えて*/, /*ここを変えて*/);
    hist_projX->Draw("E");    
}
